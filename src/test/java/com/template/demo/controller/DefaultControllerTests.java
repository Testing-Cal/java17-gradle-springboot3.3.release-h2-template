...
public class DefaultControllerTests {
	...
	private String mockDefaultResponse() {
		return title + "Hello! You have successfully set up your Java17 Gradle SpringBoot:3.3 environment by using the Lazsa template. You're all set to start coding.";
	}
